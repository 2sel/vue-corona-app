...
<script>
import ChartGraph from "../charts/ChartGraph"; // eslint-disable-next-line
  ...
  methods: {
    async fetchDomestic() {
      ...
      const from = moment()
        ...
        .format("YYYY-MM-DD"); // 써야하는 이유 : 추후 날짜 계산하기 쉽도록 넣음
      const params = {
        to,
        from,
      };
      const url = "http://api.covid19api.com/live/country/south-korea";
    ...
    setDomesticData(domestic) {
      ...
      console.log(this.domesticData, "domestic data");
    },
  },
};
</script>
